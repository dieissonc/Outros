...
newc	= 
(
IF EXISTS (SELECT * FROM [Sistema_Monitoramento].[dbo].[Versao e Update] WHERE COMPUTADOR = '%A_ComputerName%')
UPDATE [Sistema_Monitoramento].[dbo].[Versao e Update] SET [update] = 'nao', versao = '%version%',  ip ='%ip%' WHERE computador = '%A_ComputerName%'
ELSE
