;{ conexões
if(Ping("192.9.100.186")[1].1=1)
	con	:=	"Driver={SQL Server Native Client 10.0};Server=CPC016576\IRIS10DB;Uid=ahk;Pwd=139565Sa"
else	if(Ping("192.9.100.186")[1].1=0	AND	Ping("192.9.100.184")[1].1=1)
	con	:=	"Driver={SQL Server Native Client 10.0};Server=CPC016836\IRIS10DB;Uid=ahk;Pwd=139565Sa"
else	if(Ping("192.9.100.186")[1].1=0	AND	Ping("192.9.100.184")[1].1=0	AND	Ping("192.9.100.182")[1].1=1)
	con	:=	"Driver={SQL Server Native Client 10.0};Server=SRVVDM01\IRIS10DB;Uid=ahk;Pwd=139565Sa"
else	if(Ping("192.9.100.186")[1].1=0	AND	Ping("192.9.100.182")[1].1=0	AND	Ping("192.9.100.184")[1].1=0	AND	Ping("192.9.100.183")[1].1=1)
	con	:=	"Driver={SQL Server Native Client 10.0};Server=SRVVDM02\IRIS10DB;Uid=ahk;Pwd=139565Sa"
else
{
	MsgBox Todos os servidores cadastrados não estão respondendo.`nContate o administrador do Sistema Monitoramento.
	GeraLog("Todos os servidores SQL não responderam ao PING")
}
if(Ping("10.0.20.10")[1].1=0)	{
...
GeraLog("Todos os servidores SQL e ORACLE responderam ao PING - " A_ScriptName)
