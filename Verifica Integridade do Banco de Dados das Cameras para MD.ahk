...
pgsql	=	Driver={PostgreSQL Unicode(x64)};Server=Localhost;Uid=admin;Pwd=SitPass42
bd_cameras	=		SELECT	ip,	nome	FROM	[MotionDetection].[dbo].[Cameras]	ORDER	BY	1
bd_cameras	:=	adosql(con,bd_cameras)
Loop, % bd_cameras.MaxIndex()-1
{
